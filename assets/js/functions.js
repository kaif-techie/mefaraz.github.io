...
jQuery(function () {
    ...
    function themeTouchStart() {
        jQuery(window).off("mousemove.mefaraz");
        screen_has_mouse = false;
        setTimeout(function () {
            jQuery(window).on("mousemove.mefaraz", themeMouseMove);
        }, 250);
    }
    if (!navigator.userAgent.match(/(iPad|iPhone|iPod)/g)) {
        jQuery(window).on("touchstart.mefaraz", themeTouchStart).on("mousemove.mefaraz", themeMouseMove);
    ...
    jQuery(".site-menu-toggle").on("click.mefaraz", function (e) {
    ...
    jQuery("#site-menu .menu-expand").on("click.mefaraz", function (e) {
    ...
    if (jQuery("html").hasClass("touchevents")) {
        jQuery("#site-menu li.menu-item-has-children > a:not(.menu-expand)").on("click.mefaraz", function (e) {
        ...
        jQuery("#site-menu li > a:not(.menu-expand), #top .site-title a, #social-links-menu a:first").on("focus.mefaraz blur.mefaraz", function (e) {
    ...
    jQuery(".my-info .field > a").on("click.mefaraz", function (e) {
        var $field = jQuery(this).parent();
        $field.toggleClass("show-dropdown").siblings().removeClass("show-dropdown");
        e.preventDefault();
    });
    jQuery(".my-info .dropdown .values a").on("click.mefaraz", function (e) {
    ...
    if (jQuery.fn.owlCarousel) {
        ...
        $hero_carousel.owlCarousel({
            ...
            , onInitialized: function (event) {
                ...
                jQuery('<div class="owl-expand"><a href="#"><span class="ti"></span></a></div>').insertAfter(jQuery(".owl-nav", event.target)).on("click.mefaraz", function (e) {
                    e.preventDefault();
                ...
                jQuery(".owl-stage", event.target).on("dblclick.mefaraz", function (e) {
                    $hero_carousel.find(".owl-expand:visible").trigger("click.mefaraz");
                });
                var tapedTwice = false;
                jQuery(".owl-stage", event.target).on("touchstart.mefaraz", function (e) {
                    if (!tapedTwice) {
                        tapedTwice = true;
                        setTimeout(function () {
                            tapedTwice = false;
    ...
    jQuery(".menu-overlay").on("click.mefaraz", function (e) {
        if (e.offsetX < 0 && $body.hasClass("mobile-menu-opened")) {
            jQuery(".site-menu-toggle").trigger("click.mefaraz");
        }
    });
